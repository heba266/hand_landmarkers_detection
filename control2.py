...
while True:
    ...
    if result.hand_landmarks:
        for hand_landmarks in result.hand_landmarks:
            ...
            # cv2.circle(frame, (hand_landmarks[3].X, hand_landmarks[3].Y), 10, (255, 0, 0), cv2.FILLED)
            # cv2.circle(frame, (hand_landmarks[6].X, hand_landmarks[6].Y), 10, (255, 0, 0), cv2.FILLED)
            # cv2.circle(frame, (hand_landmarks[10].X, hand_landmarks[10].Y), 10, (255, 0, 0), cv2.FILLED)
            # cv2.circle(frame, (hand_landmarks[14].X, hand_landmarks[14].Y), 10, (255, 0, 0), cv2.FILLED)
            # cv2.circle(frame, (hand_landmarks[18].X, hand_landmarks[8].Y), 10, (255, 0, 0), cv2.FILLED)
